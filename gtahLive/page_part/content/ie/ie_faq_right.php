              <div class="card">
                ...
                <div id="collapse50" class="collapse" aria-labelledby="heading50" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Definitely, yes! We value every customer and keep our services highly confidential so that no third party can have access. We also use a firewall to protect your content.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">We cover more than 600 subjects that come under the school, college, and university levels with the help of the best experts.</p>
                  </div>
                </div>
              </div>
    <!--            <div class="card">
