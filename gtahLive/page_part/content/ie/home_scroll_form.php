        ...
        <div class="row">
          ...
          <div class="col-3">
            <div class="row align-items-end">
              ...
              <div class="col-2">
                 <img src="https://www.gotoassignmenthelp.com/images/lineArrow.webp" width="35px" height="15px" alt="Form step 1 to step 2" class="img-fluid step1_2_arrow">
              <div class="col-4">
    ...
    <div class="main-wrapper hide_at_mobile hide_by_default yellow_cologbg scroll_form white_text">
      <div class="container-fluid">
          ...
          <div class="form_home_wrap">
            <form id="helpFormScroll" name="helpForm" action="https://www.gotoassignmenthelp.com/next-step-newv.php" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form form_home">
              <div class="row">
                    <div class="col-3"> 
