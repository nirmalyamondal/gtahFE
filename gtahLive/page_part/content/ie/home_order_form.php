<form id="helpForm" name="helpForm" action="https://www.gotoassignmenthelp.com/next-step-newv.php" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form form_home">										
										...
										<div class="row">
											...
											<div class="col-lg-4">
	    										...
	    										<div class="quantity">
													...
													<input name="quantity" type="text" class="quantity__input assignment_form_ip" value="1 / 250" />
										...
										<div class="row">
				        					<div class="col-8"> 
	    										<input id="upload" name="upload[]" type="file" value="" placeholder="" class="assignment_form_ip" multiple />
											</div>
											<div class="col-4">
