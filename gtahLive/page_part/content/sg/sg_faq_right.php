                ...
                <div class="card-header" id="heading50">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse50">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse50">
                      Through Which Mode You Can Make the Amount?
                    </button>
                  </h3>
                </div>
                <div id="collapse50" class="collapse" aria-labelledby="heading50" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">We accept all modes of online transactions and all types of debit and credit cards. You can choose any mode of option.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading51">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse51">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse51">
                      Will You Get Any Additional Discount If You Book Earlier?
                    </button>
                  </h3>
                </div>
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">To help every student we give a flat 51% discount on all types of essay writing service Singapore.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse52" class="collapse" aria-labelledby="heading52" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Our experts work day and night to meet the deadline. So, you can rely on our experts fully.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse53" class="collapse" aria-labelledby="heading53" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Yes. Our experts never disclose the identity of its customers with anyone. So, it is a fully safe option to avail.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse54" class="collapse" aria-labelledby="heading54" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">GotoAssignmentHelp.com has been serving the students for the last few years with grace in return for very cheap wages. We never miss a deadline. Solutions are customized and plagi-free.</p>
                  </div>
                </div>
              </div>
    <!--          <div class="card">
