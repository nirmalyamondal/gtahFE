              ...
              <div class="card">
                ...
                <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Availing the best study helper has never been this easy. Best experts are just 3 clicks away. Visit GotoAssignmentHelp and fill a simple form, pay partial half of the quoted amount to start the work and book your service right now. Rest is done by the professional team within the given time period with 100% precision.</p>
                  </div>
                </div>
              </div>
              <div class="card">
