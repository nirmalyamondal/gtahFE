                ...
                <div class="card-header" id="heading1">
                  <h3 class="mb-0 accord_head" aria-expanded="true" aria-controls="collapse1">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1">
                      What do You Mean by Assignment Help Cyprus Service?<span class="plus_minus_accordion">&nbsp;</span>
                    </button>
                  </h3>
                </div>
                <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">It is a type of service that is specially built for the students of Cyprus and through this service, various types of assistance are provided to students.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">We have Ph.D.-qualified skilled experts who work on students assignments and study materials.</p>
