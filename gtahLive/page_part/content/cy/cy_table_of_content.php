        ...
        <div class="row">
              <div class="col-12">
                <div class="yellow_dot_ulli deepgrey_colorbg p-3">
                  <ul>
                    <li><a href="#content1">Googling for the Best Assignment Help Service in Cyprus? Check Out Our Services</a></li>
            ...
            <p>&nbsp;</p> 
                <span id="content1">
                  <h2>Googling for the Best Assignment Help Service in Cyprus? Check Out Our Services</h2>                 
              <p class="text-justify">Students who are looking for the best assignment help service, for them this is the ideal platform. We provide all types of services at an affordable rate. Students can choose their experts and improve their academic grades easily.</p>
			  <p class="text-justify">We have a large number of students from top universities in Cyprus, who regularly avail of our services, these include –</p>
              <div class="yellow_dot_ulli">
                <ul>
                  <table class="table border">
                    <tbody>
                      <tr>
                        <td class="border"><li>University of Cyprus</li></td>
                        <td class="border"><li>European University Cyprus</li></td>
                        <td><li>University of Nicosia</li></td>
                      </tr>
                      <tr>
                        <td class="border"><li>Cyprus University of Technology</li></td>
                        <td class="border"><li>Neapolis University Pafos</li></td>
                        <td><li>Cyprus College</li></td>
                      </tr>
                      <tr>
                        <td class="border"><li>Open University of Cyprus</li></td>
                        <td class="border"><li>Fredrick University, Limassol, Cyprus</li></td>
                        <td><li>The Cyprus Institute</li></td>
                      </tr>
                    </tbody>
                  </table>
                </ul>             
