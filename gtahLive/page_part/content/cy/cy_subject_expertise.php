          ...
          <div class="row">
              ...
              <div class="col-sm-3">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                  <a class="nav-link active" id="v-pills-History-tab" data-toggle="pill" href="#v-pills-History" role="tab" aria-controls="v-pills-History" aria-selected="true">History<span class="blue_arrow">&nbsp;</span></a>
                  <a class="nav-link" id="v-pills-Human-Resource-Management-tab" data-toggle="pill" href="#v-pills-Human-Resource-Management" role="tab" aria-controls="v-pills-Human-Resource-Management" aria-selected="false">Human Resource Management<span class="blue_arrow">&nbsp;</span></a>
                  ...
                  <div class="tab-pane fade show active" id="v-pills-History" role="tabpanel" aria-labelledby="v-pills-History-tab">
                      <div class="row">
                        <div class="col-12 col-md-8">
                          <p class="text-justify">History is an interesting subject. It is a subject that tells us about the evolution of mankind from the Harappan civilization to the modern time of artificial intelligence. It records continuous, chronologically important events of individuals and as a race. As history is a very vast and lengthy subject, students find it hard to invest so much time to prepare the assignment. In history, students need to remember lots of information like dates, wars, treaties, peace agreements, etc. Writing history assignments is not all about writing lengthy stories of the past. It needs precise collection and compilation of necessary and important information.</p>
						  <p class="text-justify">Thus, it makes preparing history assignments a very difficult and tiresome task. To make life easier for the students of Cyprus, GotoAssignmentHelp has started online history assignments writing help Cyprus and writing assignment help service. We have a team of assignments writing help history scholars in Cyprus who work day in and day out to prepare writing assignment help for the students of Cyprus. Assignments writing help team of GotoAssignmentHelp also provide students with assignment writing help Cyprus against the best price in the market.</p>
					
						  
                        </div>
                        <div class="col-12 col-md-4 hide_at_mobile">
                          <img src="https://www.gotoassignmenthelp.com/images/history.webp" title="History subject expert" alt="History subject expert" width="262px" height="282px" class="img-fluid" />
                        </div>
                      </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-Human-Resource-Management" role="tabpanel" aria-labelledby="v-pills-Human-Resource-Management-tab">
                      <div class="row">
                        <div class="col-12 col-md-8">
                          <p class="text-justify">Human is the fundamental base for any kind of production. Human resource management deals with managing the human capital of an organization. It takes necessary steps so that there is the best utilization of available human resources of an organization. The HR department also addresses various issues of the current set of employees like benefits, pay, employee investments, training, pension plans, etc.</p>
						  <p class="text-justify">Another important responsibility of the human resource management department is settling if there is any kind of conflict between the employer and employees. In modern times, HR departments are more functional than traditional organizations. HR department makes employees understand how their performance contributes to the overall development of the company. As the students don’t get enough time to prepare assignments, they need to access outsourced assignment writing help services. GotoAssignmentHelp is the leading human resource assignment help service provider in the market that provides students of Cyprus premium quality assignments writing help service to the students. If you need any kind of writing assignment help regarding Human Resource Management, you can always contact us for writing assignment help.</p>
						  
						  
                        </div>
                        <div class="col-12 col-md-4 hide_at_mobile">
                          <img src="https://www.gotoassignmenthelp.com/images/management.webp" title="Human resource management subject expert" alt="Human resource management subject expert" width="262px" height="282px" class="img-fluid" />
                        </div>
                      </div>                  
                    </div>
