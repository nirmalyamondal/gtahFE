                ...
                <div class="card-header" id="heading50">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse50">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse50">
                      Can I Get Assignment Help On All Subjects?
                    </button>
                  </h3>
                </div>
                <div id="collapse50" class="collapse" aria-labelledby="heading50" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Yes, we are tied up with assignment maker on more than 200 subjects.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading51">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse51">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse51">
                      How many Experts Available Here?
                    </button>
                  </h3>
                </div>
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">The strength of GotoAssignmentHelp’s team of experts is more than five thousands.</p>
                  </div>
                </div>
              </div>
           <!--   <div class="card">
                <div class="card-header" id="heading52">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse52">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse52">
                      Is It Legal to Pay Someone for Assignment Service?
                    </button>
                  </h3>
                </div>
                <div id="collapse52" class="collapse" aria-labelledby="heading52" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">It is not accepted by schools and colleges to submit work done by professionals but it is not fair to burden students as well so we advise students to use their work for reference and also help them in completing the assignments.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading53">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse53">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse53">
                     Why do Students Avail Online Assignment Help?
                    </button>
                  </h3>
                </div>
                <div id="collapse53" class="collapse" aria-labelledby="heading53" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Due to lack of time and resources, students prefer online assignment help services which eases their academic burden.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse54" class="collapse" aria-labelledby="heading54" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">It focuses on providing rich and informative content along with a professional writing experience and meeting deadlines. It brings high grades to students by making the assignments plagiarism free and error free.</p>
                  </div>
                </div>
              </div>
    <!--          <div class="card">
