              ...
              <div class="card">
                ...
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">All the subjects that are catered in the universities are dealt with utmost care at GotoAssignmentHelp. Starting from Management to Accounting, Engineering, Healthcare, Humanities, Medical, CDR and many other subjects are catered under our service assignment writing help Australia.</p>
                  </div>
                </div>
              </div>
              <div class="card">
