                ...
                <div class="card-header" id="heading50">
                  <h5 class="mb-0 accord_head">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse50" aria-expanded="false" aria-controls="collapse50">
                      Are the Payment Methods Safe and Secure?
                    </button>
                  </h5>
                </div>
                <div id="collapse50" class="collapse" aria-labelledby="heading50" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Yes! All our transactions are secured by our payment gateway.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">As you create your profile by visiting our website, there you would get a form, you need to fill out the form, and here you will get the option to submit your assignment.</p>
                  </div>
                </div>
              </div>
        <!--     <div class="card">
