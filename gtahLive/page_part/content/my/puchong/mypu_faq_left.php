                ...
                <div class="card-header" id="heading1">
                  <h5 class="mb-0 accord_head">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                      What is the Minimum Possible Time to Deliver an Assignment?<span class="plus_minus_accordion">&nbsp;</span>
                    </button>
                  </h5>
                </div>
                <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">According to the deadline of customers, our team starts working on it; if you have 2 days or 2 hours, our experts are able to deliver your assignment on time.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading2">
                  <h5 class="mb-0 accord_head">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse2" aria-expanded="false" aria-controls="collapse2">
                     How Many Subjects Covered by Assignment Help Team?
                    </button>
                  </h5>
                </div>
                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Under assignment help service, we cover more than 600 subjects based on various topics and streams.</p>
