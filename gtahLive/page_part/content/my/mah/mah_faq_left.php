                ...
                <div class="card-header" id="heading1">
                  <h5 class="mb-0 accord_head">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                      How to Pay the Fee?<span class="plus_minus_accordion">&nbsp;</span>
                    </button>
                  </h5>
                </div>
                <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Students can pay the fee using any mode, i.e. debit or credit cards, online transactions etc too.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Under our team, we have skilled Ph.D.-Qualified experts who work on behalf of students.</p>
