                ...
                <div class="card-header" id="heading50">
                  <h5 class="mb-0 accord_head">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse50" aria-expanded="false" aria-controls="collapse50">
                      What Kind of Experience Does the Assignment Help Experts Have?
                    </button>
                  </h5>
                </div>
                <div id="collapse50" class="collapse" aria-labelledby="heading50" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Our experts have years of experience in their particular profession and they use it skilfully while working on an assignment.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading51">
                  <h5 class="mb-0 accord_head">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse51" aria-expanded="false" aria-controls="collapse51">
                      What Should I Do for Customer Support?
                    </button>
                  </h5>
                </div>
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">You can visit our official website and go to the chat section to chat with our experts.</p>
                  </div>
                </div>
              </div>
        <!--      <div class="card">
