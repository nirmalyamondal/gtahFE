                ...
                <div class="card-header" id="heading1">
                  <h3 class="mb-0 accord_head" aria-expanded="true" aria-controls="collapse1">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1">
                      How Can I Get Thesis Help Malaysia?<span class="plus_minus_accordion">&nbsp;</span>
                    </button>
                  </h3>
                </div>
                <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Order your requirements at the official website of GotoAssignmentHelp, for any enquiry chat with our experts.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">If any student fails in the examination, we ensure complete money back guarantee.</p>
