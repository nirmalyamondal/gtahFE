                ...
                <div class="card-header" id="heading1">
                  <h5 class="mb-0 accord_head">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                      Is There a Guarantee that I will Get A+ Grades in Academics?<span class="plus_minus_accordion">&nbsp;</span>
                    </button>
                  </h5>
                </div>
                <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">As your assignment is done, we have a team of experts who check the quality of your writing and
they assure students about the grades that students can acquire by submitting it.
</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Our experts never compromise with the quality of content and it covers almost all academic levels,
from school to higher academic degrees.
</p>
