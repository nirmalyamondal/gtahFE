              ...
              <div class="col-md-4">  
                <div class="rareview_top_block">
                  ...
                  <div class="rareview_head">
                    <h3 class="expert_name">Homework</h3>
                    ...
                    <p class="rareview_country">United State</p>
                  </div>
                </div>
                <div class="rareview_middle_block">
                  <p class="rareview_text">I regularly hire homework help USA services from the GTAH Team. Its top writers help me to get good grades in essay writing.</p>
                </div>
                <div class="rareview_bottom_block">
                  ...
                  <div class="rareview_text_bottom">
                    <p><b>Tim Dorsey</b><br/>Cust. ID #54867</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4">  
                ...
                <div class="rareview_middle_block">
                  <p class="rareview_text">With the help of the GTAH team, I got an A+ grade in academics. Thank you so much for it.</p>
                </div>
                <div class="rareview_bottom_block">
                  <div class="rareview_image_bottom">
                    <img src="https://www.gotoassignmenthelp.com/images/inverted_comma_end.webp" alt="Ross Williams" width="34px" height="26px" />
                  ...
                  <div class="rareview_text_bottom">
                    <p><b>Diya Thomson</b><br/>Cust. ID #44719</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4">  
                ...
                <div class="rareview_middle_block">
                  <p class="rareview_text">Excellent support and guidance from GTAH. I regularly avail assignment assistance for qualitative work.</p>
                </div>
                <div class="rareview_bottom_block">
                  <div class="rareview_image_bottom">
                    <img src="https://www.gotoassignmenthelp.com/images/inverted_comma_end.webp" alt="Ross Williams" width="34px" height="26px" />
                  ...
                  <div class="rareview_text_bottom">
                    <p><b>Barak Johnson</b><br/>Cust. ID #54913</p>
                  </div>
                </div>
              </div>
          </div>
