                ...
                <div class="card-header" id="heading1">
                  <h3 class="mb-0 accord_head" aria-expanded="true" aria-controls="collapse1">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1">
                      What Do You Mean by Thesis Help USA Service?<span class="plus_minus_accordion">&nbsp;</span>
                    </button>
                  </h3>
                </div>
                <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">It is a thesis help service through which assistance is given in all types of thesis writing and it is specially designed for the students of the USA.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading2">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse2">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse2">
                     How Much Do You Have to Pay for the Availing of Experts?
                    </button>
                  </h3>
                </div>
                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">We charge based on the subject, type of services, and complexity. But don’t worry, we charge very fewer wages to customers so that they can easily avail of it without considering it a burden. </p>
        ...
        <!--       <div class="card">
                ...
                <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Of course. Availing Online assignment help Singapore is undoubtedly a safe and secure option for the students in their time of need.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">To avail of the assignment writing service Singapore, students just need to log on to our official website and place their order.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">The amount charged by our experts is totally based on the type of assignment writing service Singapore that you are availing yourself. In return for all these services, we charge very less.</p>
                  </div>
                </div>
              </div>
             <div class="card">
