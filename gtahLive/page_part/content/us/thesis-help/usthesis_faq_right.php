              <div class="card">
                ...
                <div id="collapse50" class="collapse" aria-labelledby="heading50" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">If students request a revision, then we offer an unlimited revision option and it is given completely free of cost. </p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading51">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse51">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse51">
                      Who Would Write My Thesis Papers?
                    </button>
                  </h3>
                </div>
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Under our thesis help USA team, we have skilled Ph.D.-qualified experts who are able to deal with every complex type of writing.</p>
                  </div>
                </div>
              </div>
      <!--           <div class="card">
