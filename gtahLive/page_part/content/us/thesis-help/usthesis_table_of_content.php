        ...
        <div class="row">
              <div class="col-12">
                <div class="yellow_dot_ulli deepgrey_colorbg p-3">
                  <ul>
                    <li><a href="#content1">Googling for the Most Affordable Thesis Help Service in the USA? Check Out Our Services</a></li>
            ...
            <p>&nbsp;</p> 
                <span id="content1">
                  <h2>Googling for the Most Affordable Thesis Help Service in the USA? Check Out Our Services</h2>                 
              <p class="text-justify">If you are looking for the most affordable thesis help service in the USA, then it is the ideal platform for you. We provide all types of services at very fewer wages so that everyone can avail of our services. So, till the time we are here, students don’t need to think about their thesis papers.We have a large number of students from top universities in the USA who regularly avail of our thesis help USA service and improve their academic grades, these include
</p>
              <div class="yellow_dot_ulli">
                <ul>
                  <table class="table border">
                    <tbody>
                      <tr>
                        <td class="border"><li>Massachusetts Institute of Technology</li></td>
                        <td class="border"><li>Harvard University</li></td>
                        <td><li>Stanford University</li></td>
                      </tr>
                      <tr>
                        <td class="border"><li>Yale University </li></td>
                        <td class="border"><li>University of Chicago</li></td>
                        <td><li>John Hopkins University </li></td>
                      </tr>
                      <tr>
                        <td class="border"><li>University of Pennsylvania</li></td>
                        <td class="border"><li>California Institute of Technology</li></td>
                        <td><li>Princeton University</li></td>
                      </tr>
                    </tbody>
                  </table>
                </ul>             
