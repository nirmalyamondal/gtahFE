              <div class="card">
                ...
                <div id="collapse50" class="collapse" aria-labelledby="heading50" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Yes, you can choose your expert from whom you can get your assignments done.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading51">
                  <h5 class="mb-0 accord_head">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse51" aria-expanded="false" aria-controls="collapse51">
                      How Much Discount Available Right Now?
                    </button>
                  </h5>
                </div>
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Up to 51% discount is always available.</p>
                  </div>
                </div>
              </div>
    <!--            <div class="card">
