                ...
                <div class="card-header" id="heading50">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse50">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse50">
                      What Mode of Payment is Accepted by Expert Assignment Help?
                    </button>
                  </h3>
                </div>
                <div id="collapse50" class="collapse" aria-labelledby="heading50" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">We accept all modes of payment. You can make your payments by using debit and credit cards, various types of online transactions etc. too.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading51">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse51">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse51">
                      Will I Get an Additional Discount If I Book Expert Assignment Help Earlier?
                    </button>
                  </h3>
                </div>
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">After this pandemic situation, we offer flat 51% discounts on all our services. So, this offer is valid for everyone.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading52">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse52">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse52">
                      Do the Assignment Help Experts UK Meet the Deadline?
                    </button>
                  </h3>
                </div>
                <div id="collapse52" class="collapse" aria-labelledby="heading52" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Of course, yes! Our experts work day and night and finish the work within the stipulated time.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading53">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse53">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse53">
                     Will I Get Doubt Clearing Classes If I have Doubt on a Topic?
                    </button>
                  </h3>
                </div>
                <div id="collapse53" class="collapse" aria-labelledby="heading53" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Be sure that our assignment help experts UK will surely provide online doubt clearing classes after delivering the material and they will solve all your queries regarding the topic</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading54">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse54">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse54">
                     Why GotoAssignmentHlep.Com is the Best in the Market?	
                    </button>
                  </h3>
                </div>
                <div id="collapse54" class="collapse" aria-labelledby="heading54" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">We provide quality projects to the students which are plagiarism free and rich in quality making the students get the desired grades.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse55" class="collapse" aria-labelledby="heading55" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">It has been serving the students for the last few years. Within a short span they have got immense success. Its pocket friendly service and student’s friendly behaviour and the expert assignment help are the reasons to be the best in the market.</p>
                  </div>
                </div>
              </div>
        <!--      <div class="card">
