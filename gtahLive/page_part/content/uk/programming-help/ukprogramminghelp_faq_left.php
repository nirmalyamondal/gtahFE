                ...
                <div class="card-header" id="heading1">
                  <h3 class="mb-0 accord_head" aria-expanded="true" aria-controls="collapse1">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1">
                      What Do You Mean by Programming Assignment Help UK Service?<span class="plus_minus_accordion">&nbsp;</span>
                    </button>
                  </h3>
                </div>
                <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">It is basically a service that is served by skilled programming assignment helpers to the students who find completing assignments to be a difficult part.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading2">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse2">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse2">
                     What is the Main Motive of Programming Assignment Writing Service?
                    </button>
                  </h3>
                </div>
                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">The main motto of the team of programming assignment writing service is to serve every student with high-quality content at a reasonable rate.</p>
                ...
                <div class="card-header" id="heading3">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse3">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse3">
                     How to Book Your Do My Programming Assignment Services?
                    </button>
                  </h3>
                </div>
                <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">To place your order, you need to visit our official website and fill up a form based on your requirements; that’s all.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading4">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse4">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse4">
                      Is Availing Programming Assignment Writing Service Legit?
                    </button>
                  </h3>
                </div>
                <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Yes! At present, availing services like programming help has become 100% legit. Most students of top universities in the UK regularly rely on these experts to increase their academic grades and reduce their burden.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading5">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse5">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse5">
                     Does the Coding Assignment Help Team Meet the Deadline?
                    </button>
                  </h3>
                </div>
                <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Our programming assignment helpers work round the clock keeping in mind to finish the project within the assured time.</p>
                  </div>
                </div>
              </div>
           <!--    <div class="card">
