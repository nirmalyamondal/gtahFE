                ...
                <div class="card-header" id="heading50">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse50">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse50">
                      What is the Refund Policy of Programming Assignment Help UK Service?
                    </button>
                  </h3>
                </div>
                <div id="collapse50" class="collapse" aria-labelledby="heading50" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">If students are not satisfied with the work of our team, then we offer a 100% money-back guarantee scheme to our customers.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading51">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse51">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse51">
                      What is the Privacy Policy of Programming Assignment Writing Service?
                    </button>
                  </h3>
                </div>
                <div id="collapse51" class="collapse" aria-labelledby="heading51" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Our experts never share any information about its customers with any third party, all the information is kept highly confidential.</p>
                  </div>
                </div>
              </div>
             <div class="card">
                <div class="card-header" id="heading52">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse52">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse52">
                      What is the Fee Structure of Availing Programming Assignment Help UK Experts?
                    </button>
                  </h3>
                </div>
                <div id="collapse52" class="collapse" aria-labelledby="heading52" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">Our programming assignment help UK team charges the fee based on the type of services that you are availing of. We charge very minimal wages so that everyone can avail of it without considering it a burden.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading53">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse53">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse53">
                     Do I Get an Additional Discount if I Book Programming Assignment Help UK Service Earlier?
                    </button>
                  </h3>
                </div>
                <div id="collapse53" class="collapse" aria-labelledby="heading53" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">At present, our help with programming assignment team is offering a flat 51% discount on all types of services under programming assignment help UK.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading54">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse54">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse54">
                     Why GotoAssignmentHelp is Considered to be the Best in the Market? 	
                    </button>
                  </h3>
                </div>
                <div id="collapse54" class="collapse" aria-labelledby="heading54" data-parent="#accordionRight">
                  <div class="card-body">
                    <p class="text-justify">GotoAssignmentHelp has been serving various types of programming help for the last few years with smiles and grace. Its key attractions are the student-friendly behaviour of its experts, pocket-friendly budget, on-time delivery, etc.</p>
                  </div>
                </div>
              </div>
         <!--      <div class="card">
