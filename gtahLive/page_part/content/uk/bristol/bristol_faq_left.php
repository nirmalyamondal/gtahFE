                ...
                <div class="card-header" id="heading1">
                  <h3 class="mb-0 accord_head" aria-expanded="true" aria-controls="collapse1">
                    <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapse1">
                      What do You Mean by Assignment Help Bristol Service?<span class="plus_minus_accordion">&nbsp;</span>
                    </button>
                  </h3>
                </div>
                <div id="collapse1" class="collapse show" aria-labelledby="heading1" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">It is a type of assignment help service through which various types of assistance are provided to the students of Bristol.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                ...
                <div id="collapse2" class="collapse" aria-labelledby="heading2" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">We always try to provide 100% satisfactory content to our customers. Still, if they are not satisfied with our content, then we offer a 100% money-back guarantee scheme.</p>
         ...
         <!--     <div class="card">
                ...
                <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">The experts at GotoAssignmentHelp are well trained and experienced in making the best projects for the students. They are skilled and experienced PhD experts.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading4">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse4">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse4">
                      Do You Offer Assignment and Homework Help?
                    </button>
                  </h3>
                </div>
                <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">Yes, we provide project help, homework help, dissertation help, case study help, etc. on more than 600 subjects.</p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header" id="heading5">
                  <h3 class="mb-0 accord_head" aria-expanded="false" aria-controls="collapse5">
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapse5">
                     How Do I Find My Assignment Expert?
                    </button>
                  </h3>
                </div>
                <div id="collapse5" class="collapse" aria-labelledby="heading5" data-parent="#accordionLeft">
                  <div class="card-body">
                    <p class="text-justify">You have to fill a form regarding the details of the service you want and then you can choose the best expert according to your requirements.</p>
                  </div>
                </div>
              </div>
              <div class="card">
