...
(function($) {
	$.fn.stellarNav = function(options, width, breakpoint) {
		...
		return this.each( function() {
			...
			//nav.prepend('<a href="#" class="menu-toggle ' + cssClass + '"><div class="bar_container"><div class="bar1 red_cologbg"></div><div class="bar2 red_cologbg"></div><div class="bar3 red_cologbg"></div></div><!--i class="fa fa-bars"></i--> <div class="menu_txt_mobile"><!--Menu--></div><span class="float-end blue_gradient_discount rounded white_text h5">FLAT 51% OFF</span></a>');
